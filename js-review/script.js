...
const updatedBook = { ...book, moviePublicatioinDate: "2001-01-05" };

const bookLiteral = `${title} is a ${pages}-page long book, was written by ${author} and published in ${publicationDate}`;
